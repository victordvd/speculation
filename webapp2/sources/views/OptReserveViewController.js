...
var ReserveModel_1 = require("../models/ReserveModel");
var OptReserve_1 = require("./OptReserve");
...
var OptReserveViewController = /** @class */ (function () {
    function OptReserveViewController() {
        var _this = this;
        this.init = function () {
        ...
        this.loadData = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        grid = $$(OptReserve_1.default.viewIds.rsvGrid);
                        return [4 /*yield*/, ReserveModel_1.default.selectOptReserveData()];
                    case 1:
                        data = _a.sent();
                        grid.clearAll();
    ...
    return OptReserveViewController;
}());
exports.default = OptReserveViewController;
//# sourceMappingURL=OptReserveViewController.js.map