...
var MachineDownViewController_1 = require("./MachineDownViewController");
var EditorController_1 = require("../../controllers/EditorController");
var MachineDown = /** @class */ (function (_super) {
    __extends(MachineDown, _super);
    function MachineDown() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.ctrl = new MachineDownViewController_1.MachineDownViewController();
        _this.init = _this.ctrl.init;
        return _this;
    }
    MachineDown.prototype.config = function () {
        // webix.editors.$popup = {
        //     date:{
        //         view:"popup",
        ...
        var layout = {
            rows: [
                ...
                },
                {
                    ...
                    rules: {
                        "TOOL_ID": function (value) {
                            return value != "";
                        },
                        "DOWN_START": function (val) {
                            if (val == null || val == '') {
                                MachineDown.isDataValid = false;
                                return MachineDown.isDataValid;
                            }
                            var grid = $$(MachineDown.viewIds.downGrid);
                            ...
                            if (!row)
                                return true;
                            var end = grid.data.pull[row].DOWN_END;
                            MachineDown.isDataValid = val < end;
                            return MachineDown.isDataValid;
                        },
                        "DOWN_END": function (val) {
                            if (val == null || val == '') {
                                MachineDown.isDataValid = false;
                                return MachineDown.isDataValid;
                            }
                            ...
                            if (!row)
                                return true;
                            var start = grid.data.pull[row].DOWN_START;
...
exports.default = MachineDown;
//# sourceMappingURL=MachineDown.js.map