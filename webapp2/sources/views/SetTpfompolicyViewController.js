...
var SetTpfompolicyViewController = /** @class */ (function () {
    function SetTpfompolicyViewController(view) {
        ...
        this.loadData = function () {
            ...
            SetTpfompolicyModel_1.default.selectTpfompolicy(function (rawData) {
                ...
                var _loop_1 = function (i) {
                    var step = gridData[i].PROCESSOPERATIONNAME;
                    var eqp = gridData[i].MACHINENAME;
                    var prodData = alasql("select PRODUCTSPECNAME from ? where PROCESSOPERATIONNAME = '" + step + "' and MACHINENAME = '" + eqp + "'", [rawData]);
                    //process active prod -> 1
                    prodData.forEach(function (prodRec) {
                        var prod = prodRec.PRODUCTSPECNAME;
                        gridData[i][prod] = 1;
                    });
        ...
        this.onSaveBtnClick = function (id) { return __awaiter(_this, void 0, void 0, function () {
            var factory, modu, setTable, setTabVo, checkAnotherVerFn, insertToSetTabFn, insertToVerTabFn, reloadFn;
            var _this = this;
            return __generator(this, function (_a) {
                factory = TextStore_1.default.FACTORY.ARRAY;
                modu = TextStore_1.default.MODULE.PHOTO;
                setTable = TextStore_1.default.SET_TABLES.SET_TPFOMPOLICY;
        ...
        */
                ...
                insertToVerTabFn = function (guid, callback) {
                    GlobalModel_1.default.insertSetVerCtrl(guid, TextStore_1.default.FACTORY.ARRAY, TextStore_1.default.MODULE.PHOTO, '', TextStore_1.default.SET_TABLES.SET_TPFOMPOLICY, GlobalStore_1.default.user, function () {
