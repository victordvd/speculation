...
var JobChangeModel = /** @class */ (function () {
    function JobChangeModel() {
    }
    JobChangeModel.prototype.selectJobChange = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Proxy_1.querySql(sql)];
                    case 1:
                        resp = _a.sent();
    ...
    JobChangeModel.prototype.selectPreviousJobChange = function () {
        return __awaiter(this, void 0, void 0, function () {
            var sql, resp;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    return JobChangeModel;
}());
exports.default = JobChangeModel;
//# sourceMappingURL=JobChangeModel.js.map