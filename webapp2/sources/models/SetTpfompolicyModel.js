...
var SetTpfompolicyModel = /** @class */ (function () {
    function SetTpfompolicyModel() {
    }
    ...
    // }
    SetTpfompolicyModel.selectTpfompolicy = function (callback) {
        var sql = "select productspecname , processoperationname, machinename,1 active\n      from set_tpfompolicy s\n      where exists (select id from v_set_lastest_version v where v.id = s.parentid)\n      and active = 'Y'";
        /* 2019/10/22
    ...
    SetTpfompolicyModel.insertTpfompolicy = function (sql, callback) {
        Proxy_1.querySqlCallBack(sql, callback);
    };
    return SetTpfompolicyModel;
}());
exports.default = SetTpfompolicyModel;
//# sourceMappingURL=SetTpfompolicyModel.js.map