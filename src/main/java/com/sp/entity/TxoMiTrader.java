...
/**
 * The persistent class for the TXO_MI_TRADER database table.
 * 
 */
@Entity
@Table(name="TXO_MI_TRADER")
@NamedQuery(name="TxoMiTrader.findAll", query="SELECT t FROM TxoMiTrader t")
public class TxoMiTrader implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TxoMiTraderPK id;
	...
	public TxoMiTraderPK getId() {
		return this.id;
	}

	public void setId(TxoMiTraderPK id) {
		this.id = id;
	}
