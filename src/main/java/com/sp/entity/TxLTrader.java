...
/**
 * The persistent class for the TX_L_TRADER database table.
 * 
 */
@Entity
@Table(name="TX_L_TRADER")
@NamedQuery(name="TxLTrader.findAll", query="SELECT t FROM TxLTrader t")
public class TxLTrader implements Serializable {
	private static final long serialVersionUID = 1L;

	@EmbeddedId
	private TxLTraderPK id;
	...
	public TxLTraderPK getId() {
		return this.id;
	}

	public void setId(TxLTraderPK id) {
		this.id = id;
	}
